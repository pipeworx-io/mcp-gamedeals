...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/search_deals \
  -H 'Content-Type: application/json' \
  -d '{"upper_price":10,"sort_by":"Deal Rating","page_size":20}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/search_deals`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
